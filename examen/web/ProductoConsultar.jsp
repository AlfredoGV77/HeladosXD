<%-- 
    Document   : ProductoConsultar
    Created on : 04-may-2021, 20:03:42
    Author     : bailarina77
--%>
        ...
        <table border="2" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="ProductoEditar.jsp?id=<%=rs.getInt("id_producto")%>" > Editar </a> </td>
                    <td> <a href="ProductoBorrar.jsp?id=<%=rs.getInt("id_producto")%>" > Borrar </a> </td>
            ...
            <br>
            <a href="Productoindex.html" >Regresar al Menú Principal</a>
            <br>
            <a href="ProductoRegistrar.jsp" >Registrar Nuevo Producto</a>
    </body>
</html>
s
